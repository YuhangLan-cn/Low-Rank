...
PDE_DENSE_EPOCHS="${PDE_DENSE_EPOCHS:-800}"
PDE_SPARSE_EPOCHS="${PDE_SPARSE_EPOCHS:-1500}"
PDE_LEARNING_RATE="${PDE_LEARNING_RATE:-1e-3}"
PDE_LAMBDA_RIDGE="${PDE_LAMBDA_RIDGE:-1e-6}"
PDE_LAMBDA_G="${PDE_LAMBDA_G:-1e-1}"
...
PDE_W_THRESHOLD="${PDE_W_THRESHOLD:-1e-2}"
PDE_TERM_THRESHOLD="${PDE_TERM_THRESHOLD:-1.5e-2}"
PDE_COEFFICIENT_THRESHOLD="${PDE_COEFFICIENT_THRESHOLD:-5e-3}"
PDE_DERIVATIVE_METHOD="${PDE_DERIVATIVE_METHOD:-autograd}"
PDE_FD_BOUNDARY="${PDE_FD_BOUNDARY:-3}"
